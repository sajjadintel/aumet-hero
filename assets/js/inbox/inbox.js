...
var KTAppInbox = function() {
            ...
            templates: {
                dropdownItem: function(tagData) {
                    try {
                        ...
                        html += '<div class="tagify__dropdown__item">';
                        html += '   <div class="d-flex align-items-center">';
                        html += '       <span class="symbol sumbol-' + (tagData.initialsState ? tagData.initialsState : '') + ' mr-2" style="background-image: url(\''+ (tagData.photoUrl ? tagData.photoUrl : '') + '\')">';
    ...
    var _initAttachments = function(elemId) {
        ...
        var myDropzone = new Dropzone(id, { // Make the whole body a dropzone
            url: "myproducts/uploadfile", // Set the url for your upload script location
            parallelUploads: 20,
