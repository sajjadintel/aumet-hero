            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <div class="d-flex flex-column text-dark-75">
                    ...
                    <span class="svg-icon svg-icon-xxl mr-1">
                        ...
                        My Products</h2>
                    <span class="font-weight-normal font-size-h6 ml-12 pr-48">You can manage all your products</span>
                </div>
            </div>
        </div>
        <div class="d-flex align-items-center">
            <a id="add-product" href="javascript:;" class="btn btn-primary font-weight-normal font-size-h5 py-2 px-5" onclick="">Add Product</a>
        </div>
    </div>
</div>
...
<div class="d-flex flex-column-fluid pt-10">
    <div class="container-fluid">
        ...
        <div class="card card-custom">
            <div class="card-body">
                <!--begin: Datatable-->
                <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatableMyProducts"></div>
                <!--end: Datatable-->
            </div>
        </div>
    </div>
...
<script src="/assets/js/myProducts.js"></script>