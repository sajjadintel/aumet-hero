    ...
    <div class="subheader subheader-transparent" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                ...
                <!-- <a id="edit-product" href="#" class="btn btn-primary font-weight-normal font-size-h5 py-2 px-5" data-id="">Edit</a>           -->
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-6 p-5">
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control select2" id="scientificName" name="scientificNameId" >
                            ...
                            <div class="form-group row">
                                <textarea id="productDescription" name="description" style="height: 270px"></textarea>
                            </div>
                        </div>
                        <div class="col-6 p-10">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <div class="image-input image-input-outline" id="productBaseImage" style="background-image: url(/assets/img/product.png)">
                                        <div class="image-input-wrapper" style="background-image: url('/assets/img/product.png')"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <div class="dropzone dropzone-multi" id="productEditorPhotoGallery">
...
<script>
    ...
    var productBaseImage = new KTImageInput('productBaseImage');
    ...
    var ProductEditor = function() {
        ...
        var _initPhotoGallery = function () {
            ...
            var productEditorPhotoGallery = new Dropzone(id, { // Make the whole body a dropzone
                url: "/en/myproducts/add/gallery/upload", // Set the url for your upload script location
                parallelUploads: 20,
        ...
        function fnCallbackSaveProduct(webReponse){
        ...
        var _handleFormSubmit = function (){
            $('#frmEditProduct').submit(function ( e ) {
                ...
                //formData.append('description', JSON.stringify(_quill.getContents()));
                WebApp.postFormData('#frmEditProduct','myproducts/add', formData, fnCallbackSaveProduct);
            });
        }
    ...
    $(document).ready(function() {
        ...
        /*
                ...
                $("div#kt_dropzone_1").dropzone({
                    url: "/@language/myproducts/uploadfile"
                });
