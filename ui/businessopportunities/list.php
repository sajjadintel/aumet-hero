                ...
                <div id="distributorFilters" class="mb-7">
                    ...
                    <div class="card card-custom shadow-none gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Filter Business Opportunities</h3>
                        </div>
                        <!--begin::Form-->
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter manufacturer name" name="ManufacturerName">
                                        <span class="form-text text-muted">Please enter manufacturer name</span>
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Distributor Name:</label>
                                        <input type="text" class="form-control" id="kt_datatable_search_query" placeholder="Enter distributor name" name="DistributorName">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" class="form-control" value="" name="sendDateTime" id="kt_datepicker_2" readonly="readonly" placeholder="Select date">
...
<!--                                    </div>-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="reminderCount" class="form-control" placeholder="">
                                        </div>
                                        <span class="form-text text-muted">Please enter number of follow up</span>
                                    </div>
                                    <div class="col-lg-4">
                ...
                <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatableBusinessOpportunity"></div>
...
<script src="/assets/js/dt/businessOpportunities.js"></script>
