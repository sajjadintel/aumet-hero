...
<div class="subheader subheader-solid" id="kt_subheader">
    <div class="card-body">
        ...
        <div class="d-flex mb-4 h-175px mx-n9 mt-n9 justify-content-between p-2" style="background-color: #0a6aa1;background-image: url('<?php echo $objManufacturerCompany->Banner ? $objManufacturerCompany->Banner : "/assets/img/samplebg-1.jpeg" ?>');background-repeat: no-repeat;background-size: 100%;background-position: top center;">
        </div>
                            ...
                            <div class="d-flex flex-wrap mt-1">
                                <div class="d-flex flex-column flex-grow-1 pr-8">
                                    <div class="d-flex flex-wrap text-dark-50 font-size-h5 font-weight-bold mb-4">
                                        ...
                                        <span class="ml-lg-5 ml-3 text-capitalize">Medical <?php echo $objManufacturerCompany->Type ?></span>
                                    </div>
                                </div>
            ...
            <div class="d-flex mb-5">
                <span class="font-weight-bold text-dark-75 font-size-h6">
                    <div class="scroll scroll-pull" data-scroll="true" data-wheel-propagation="true" style="height: 150px" id="descriptionContainer">
                        <?php echo html_entity_decode(str_replace("<p><br></p>", '', $objManufacturerCompany->Description)); ?>
                    </div>
                </span>
            </div>
            ...
            <div class="d-flex  justify-content-between flex-wrap mt-8">
                <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                    ...
                    <div class="d-flex flex-column text-dark-75">
                        ...
                        <span class="font-weight-bolder font-size-h4">
                            <?php echo $objManufacturerCompany->AnnualSales == null ? "<span class='text-muted'>Not Available<span>" : $objManufacturerCompany->AnnualSales ?>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                    <span class="mr-4">
                    ...
                    <div class="d-flex flex-column text-dark-75">
                        ...
                        <span class="font-weight-bolder font-size-h4"><?php echo $objManufacturerCompany->NumberOfEmployees == null ? "<span class='text-muted'>Not Available<span>" : $objManufacturerCompany->NumberOfEmployees ?></span>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                    <span class="mr-4">
                    ...
                    <div class="d-flex flex-column text-dark-75">
                        ...
                        <span class="font-weight-bolder font-size-h4"> <?php echo $objManufacturerCompany->EstablishmentYear == null ? "<span class='text-muted'>Not Available<span>" :  date("Y", strtotime($objManufacturerCompany->EstablishmentYear)) ?> </span>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                    <span class="mr-4">
                ...
                <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <?php if ($arrManufacturerSpecialities) : ?>
                            <a href="#companyProfileOverView" class="text-primary font-weight-bold">
                                <?php $itemsCounter = 0; ?>
                                <?php foreach ($arrManufacturerSpecialities as $objItem) : ?>
    ...
    <div class="container">
        ...
        <div class="d-flex flex-row">
            ...
            <div class="flex-row-auto offcanvas-mobile w-400px w-xl-450px" id="kt_profile_aside">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-60 symbol-xxl-80 mr-5 align-self-start align-self-center">
                                <div class="symbol-label" style="background-image: url('<?php echo $objManufacturerCompany->user != null ? $objManufacturerCompany->user : '/assets/img/user.svg' ?>')"></div>
                            </div>

                            <div>
                                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?php if($objAuthUser) { echo $objAuthUser->firstName . ' ' . $objAuthUser->lastName; } else { echo $objInchargePerson->FirstName . ' ' . $objInchargePerson->LastName; } ?></a>
                                <div class="text-muted mb-4"><?php if($objAuthUser) { echo $objAuthUser->position; } else { echo $objInchargePerson->JobTitle; } ?></div>
                                <div class="mt-2">
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header border-0 pt-5">
                        <h3 class="font-weight-boldest pt-5">Manufacturer pictures</h3>
                    </div>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="font-weight-normal font-size-h4"><?php echo $objManufacturerCompany->Address == null ? "<span class='font-size-h4 font-weight-normal'>Not Available<span>" : $objManufacturerCompany->Address ?></p>

                        <h5 class="text-muted mt-5 mb-3">Specialties:</h5>
                        <div class="font-weight-normal font-size-h4">
                            <?php if ($arrManufacturerSpecialities) : ?>
                                <?php foreach ($arrManufacturerSpecialities as $objItem) : ?>
                                    <div class="d-flex align-items-center mb-2">
                                        <img src="<?php echo $objItem->specialityImageUrl ?>" class="mr-5" style="width:24px">
                                        <?php echo $objItem->specialityName ?>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>
                        <h5 class="text-muted mt-5 mb-3">Social Media:</h5>
                        <div class="font-weight-normal font-size-h4">
                                    <?php if($objManufacturerCompany->facebookUrl): ?>
                                    <div class="d-flex align-items-center mb-2">
                                       <a class="socicon-btn socicon-facebook text-dark-50" href="<?php echo $objManufacturerCompany->facebookUrl ?>" target="_blank">Facebook Profile Link</a>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($objManufacturerCompany->linkedinUrl): ?>
                                    <div class="d-flex align-items-center mb-2">
                                        <a class="socicon-btn socicon-linkedin text-dark-50" href="<?php echo $objManufacturerCompany->linkedinUrl ?>" target="_blank">LinkedIn Profile Link</a>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($objManufacturerCompany->twitterUrl): ?>
                                    <div class="d-flex align-items-center mb-2">
                                        <a class="socicon-btn socicon-twitter text-dark-50" href="<?php echo $objManufacturerCompany->twitterUrl ?>" target="_blank">Twitter Profile Link</a>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($objManufacturerCompany->youtubeUrl): ?>
                                    <div class="d-flex align-items-center mb-2">
                                        <a class="socicon-btn socicon-youtube text-dark-50" href="<?php echo $objManufacturerCompany->youtubeUrl ?>" target="_blank">Youtube Channel Link</a>
                                    </div>
                                    <?php endif; ?>
                        </div>
                    </div>
                 ...
                 <input type="hidden" value="<?php echo $manufacturerId; ?>" id="manu"/>                                           
                <div class="card card-custom gutter-b">
                    <div class="card-header border-0 pt-5">
                        <h3 class="font-weight-boldest pt-5">Manufacturer documents</h3>                        
                        <?php if($enableEdit): ?>
                        <a href="javascript:;" class="btn btn-primary font-weight-bold mb-5 mt-3" onclick="WebApp.loadPage('mycompanyprofile/edit')">Upload Documents</a>
                        <?php endif ?>
                    </div>
                        ...
                        <div class="font-weight-normal font-size-h4">
                            <?php if ($arrCompanyDocuments) : ?>
                                <?php foreach ($arrCompanyDocuments as $objItem) : ?>
                                    <a href="<?php echo $objItem->Link; ?>" target="_blank" class="d-flex align-items-center mb-2 overflow-hidden" style="text-decoration: underline;">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-10">
                        <h3 class="align-items-start flex-column">
                            <span class="card-label font-weight-boldest text-dark">Product Range</span>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="card card-custom overlay">
                                        <div class="card-body p-0">
                                            ...
                                            <?php if($objCatalog->previewImageUrl): ?>
...
<script>
    ...
    var pagelimit = 5;
    var totalProducts = 0;
    var manuId = undefined;
    $(document).ready(function() {
        totalProducts = $('#randomNumber').val();      
        $('.see-less').hide();  
        manuId = $('#manu').val();        
        $('#manufacturer-products').on('scroll', function() { 
                if ($(this).scrollTop() + 
                    $(this).innerHeight() >=  
                    $(this)[0].scrollHeight) {                     
                    seeMoreProducts();    
        ...
        loadProducts(pagelimit, totalProducts, true, manuId);
    });

    function seeMoreProducts() {        
        pagelimit +=5;
        loadProducts(pagelimit, totalProducts, false, manuId);
    }
   ...
   function loadProducts(_pagelimit, _totalProducts, initial_load, manuId) {
        WebApp.loadPartialPage('#manufacturer-products', 'manufacturer-products/'+_pagelimit+'/'+_totalProducts+'/'+manuId, function(res){
            if(res.errorCode == 0) {
                ...
                if(res.message=="No More Products Found!") {
                    ...
                    if(!initial_load) {
                        $('#manufacturer-products').animate({
                            scrollTop: $("#manufacturer-products").offset().top+100
                        }, 2000);
                    }                     
                        $('.see-less').hide();
                        $('.see-more').show();
...
<script>
    am4core.ready(function() {
        ...
        var distributor = <?php echo json_encode($arrSuggestedDistributors) ?>;
        if(distributor && distributor.length>0) {
            //set mock-up lat, lng fornow
            var latitude = 4.3676; 
            var lng = 50.8371;
