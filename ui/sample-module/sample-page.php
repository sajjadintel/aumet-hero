            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <div class="d-flex flex-column text-dark-75">
                    ...
                    <span class="svg-icon svg-icon-xxl mr-1">
                        ...
                        My Sample Page</h2>
                    <span class="font-weight-normal font-size-h6 ml-12 pr-48">My Sample description</span>
                </div>
            </div>
        </div>
        <div class="d-flex align-items-center">
            <a href="javascript:;" class="btn btn-primary font-weight-normal font-size-h5 py-2 px-5" onclick="">Sample Action</a>
        </div>
    </div>
</div>
