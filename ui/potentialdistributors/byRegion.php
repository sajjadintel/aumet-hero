        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="table-responsive">
                    <table class="table table-borderless table-vertical-center table-hover font-size-h5">
                        <?php foreach ($arrRegions as $objRegion): ?>
                            <?php foreach ($objRegion->arrCountries as $objCountry): ?>
                        <tr id="countryRow<?php echo $objCountry->CountryID; ?>" class="border-bottom border-bottom-light-dark" >
                            <td class="pl-5 py-8">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50 mr-8">
                                        <span class="symbol-label bg-transparent">
                                            <img src="<?php echo $objCountry->CountryFlag; ?>" class="h-75 w-100 align-self-end" alt="">
                                        </span>
                                    </div>
                                    <div>
                                        <a  href="javascript:;" onclick="WebApp.loadPage('potentialdistributors/country/<?php echo $objCountry->CountryID; ?>')" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-h3"><?php echo $objCountry->CountryName; ?></a>
                                        <span class="text-dark-75 font-weight-bolder d-block"><?php echo $objRegion->name; ?></span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="text-dark font-weight-bolder d-block font-size-h2"><?php echo $objCountry->DistributorsCount; ?></span>
                                <span class="text-dark-75 font-weight-bold font-size-h4">Total Distributors</span>
                            </td>
                            <td>
                                <span class="text-dark font-weight-bolder d-block font-size-h2"><?php echo $objCountry->potentialDistributors == 0 ? '<span class="text-dark-50 font-weight-bold font-size-h5">Matching you with</span>' : $objCountry->potentialDistributors; ?></span>
                                <span class="text-dark-75 font-weight-bold font-size-h4">Potential Distributor</span>
                            </td>
                            <td>
                                <span class="text-dark font-weight-bolder d-block font-size-h2"><?php echo $objCountry->introductions; ?></span>
                                <span class="text-dark-75 font-weight-bold font-size-h4">Sent Introductions</span>
                            </td>
                            <td class="pr-5 text-right">
                                <?php if($objCountry->potentialDistributors > 0 ): ?>
                                    <a class="btn btn-lg btn-primary mr-5" href="javascript:;" onclick="WebApp.loadPage('potentialdistributors/country/<?php echo $objCountry->CountryID; ?>')">View Potential Distributors</a>
                                <?php else: ?>
                                    <a class="btn btn-lg btn-outline-warning mr-5" href="javascript:;" onclick="WebApp.loadPage('potentialdistributors/country/<?php echo $objCountry->CountryID; ?>')">Find Potential Distributors</a>
                                <?php endif; ?>
                                <a class="btn btn-lg btn-outline-primary" href="javascript:;" onclick="WebApp.post('profile/countries/targeted/<?php echo $objCountry->CountryID; ?>/remove', null, fnRemoveTargetCountryCallback)">Remove</a>
