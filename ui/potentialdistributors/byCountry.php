            ...
            <div class="card card-custom gutter-b">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center justify-content-between flex-wrap mt-4">
                                <div class="mr-3">
                                    <a href="javascript:;" onclick="WebApp.loadPage('browse/distributor/<?php echo $objDistributor->ID ?>')"
                                       class="d-flex align-items-center text-dark text-hover-primary font-size-h4 font-weight-bold mr-3">
                                        <?php echo $objDistributor->Name ?>
                                        <i class="flaticon2-correct text-success icon-md ml-2"></i></a>
                                    <div class="d-flex flex-wrap mt-4">
                                        <div class="symbol symbol-50">
                                            <img alt="Pic" src=" <?php echo $objDistributor->objUser->ProfileImage != null ? $objDistributor->objUser->ProfileImage : "/assets/img/user.svg"?> ">
                                        </div>
                                        <div class="ml-4">
                                            ...
                                            <span  class="text-dark text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                                ...
                                                <circle fill="#000000" opacity="0.3" cx="19.5" cy="17.5" r="2.5"></circle>
                                                    ...
                                                    <?php echo $objDistributor->objUser->Email ?>
                                            </span>
                                            <span class="text-dark text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                                <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                ...
                                                </span><?php echo $objDistributor->objUser->JobTitle ?>
                                            </span>
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-between mt-6">
                                ...
                                <button type="button" class="btn btn-outline-primary mr-5" onclick="WebApp.showModal('#modalAumetIndicatorHighlights<?php echo $objDistributor->ID ?>')">
                                    <span class="font-weight-bold text-danger"><?php echo $objDistributor->aumetIndicatorTitle ?></span> potential distributor. Click to know why?
                                </button>

                                <!-- Modal-->
                                <div class="modal fade" id="modalAumetIndicatorHighlights<?php echo $objDistributor->ID ?>"   data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-primary">Why <?php echo $objDistributor->Name ?>?</h5>
                                            </div>
                                            <div class="modal-body">
                                                <?php if (is_array($objDistributor->aumetIndicatorHighlights)):  ?>
                                                <?php foreach ($objDistributor->aumetIndicatorHighlights as $highlight):  ?>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <span href="javascript:;" class="text-dark text-hover-primary font-weight-bold font-size-lg mb-1"><?php echo $highlight; ?></span>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                                <?php else: ?>
                                                    <div class="d-flex align-items-center mb-3">
                                                        <span class="text-dark text-hover-primary font-weight-bold font-size-h5 mb-1"><?php echo $objDistributor->aumetIndicatorHighlights; ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" onclick="WebApp.hideModal('#modalAumetIndicatorHighlights<?php echo $objDistributor->ID ?>')">Close</button>
                                            </div>
                                        </div>
                                ...
                                <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5 mt-2">
                                    <div class="progress progress-xs mt-2 mb-2 flex-shrink-0 w-350px">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $objDistributor->aumetIndicator ?>%;"
                                             aria-valuenow="<?php echo $objDistributor->aumetIndicator ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex row">
                        ...
                        <div class="d-flex align-items-center flex-lg-fill col-2 mr-5 mb-2">
                            <span class="mr-4">
                        ...
                        <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a href="#companyProfileOverView" class="text-primary font-weight-bold">
                                    ...
                                    <?php else: ?>
                                        <?php $i=0; foreach ($objDistributor->arrExperience as $objItem):?>
                                            <span class="label label-light-dark label-inline mr-1 mb-1"><?php echo $objItem->specialityName;  if($i++ > 4) break;?></span>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </a>
                            </div>
