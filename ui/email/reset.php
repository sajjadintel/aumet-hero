    ...
    <tr>
        <td class="o_bg-light o_px-xs" align="center" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;">
            ...
            <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;">
                <tbody>
                <tr>
                    <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md" align="center" style="background-color: #12b9a9;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                        ...
                        <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            ...
                            <tr>
                                <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #12b9a9;border-radius: 4px;">
                                    <a class="o_text-white" href="<?php echo "$rootDomainUrl/en/auth/reset/$resetCode"?>" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Reset Your Account</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                ...
                                <tr>
                                    ...
                                    <td class="o_bg-dark o_br-r o_text-xs o_text-white o_sans o_px o_py-xs" align="left" style="vertical-align: top;font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #242b3d;color: #ffffff;border-radius: 0px 4px 4px 0px;padding-left: 16px;padding-right: 16px;padding-top: 8px;padding-bottom: 8px;">
                                        <p style="margin-top: 0px;margin-bottom: 0px;"><strong>Caution.</strong> You received this email as per your registration in one of Aumet's products. If you believe you received this by mistake please delete the message</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
