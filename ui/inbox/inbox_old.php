                        ...
                        <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                            ...
                            <div class="navi-item my-2">
                                <a href="#" class="navi-link active">
                                    ...
                                    <span class="label label-rounded label-light-success font-weight-bolder"><?php echo count ($objmessage) ;?></span>
                                    </span>
                                </a>
                            </div>
                    ...
                    <div class="card-header row row-marginless align-items-center flex-wrap py-5 h-auto">
                        ...
                        <div class="col-12 col-sm-6 col-xxl-4 order-2 order-xxl-3 d-flex align-items-center justify-content-sm-end text-right my-2">
                            ...
                            <div class="d-flex align-items-center mr-2" data-toggle="tooltip" title="" data-original-title="Records per page">
                                <span class="text-muted font-weight-bold mr-2" data-toggle="dropdown">1 - 50 of <?php echo count(($objmessage))?></span>
                        ...
                        <div class="list list-hover min-w-500px" data-inbox="list">
                            ...
                            <div class="d-flex align-items-start list-item card-spacer-x py-3" data-inbox="message">
                                ...
                                <div class="flex-grow-1 mt-2 mr-2" data-toggle="view">
                                    <div>
                                        <span class="font-weight-bolder font-size-lg mr-2"><?php echo $obj->subject;?></span>
                                        <span class="text-muted"><?php echo $obj->content;?></span>
                                    </div>
                                    <div class="mt-2">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <form id="kt_inbox_reply_form">
                                        ...
                                        <div class="d-block">
                                            ...
                                            <div class="ql-toolbar ql-snow px-5 border-top-0 border-left-0 border-right-0"> <span class="ql-formats">
                                            ...
                                            <span class="ql-formats">
                                                ...
                                                <button type="button" class="ql-italic">
                                                    <svg viewBox="0 0 18 18"> 
                                                        ...
                                                        <line class="ql-stroke" x1="8" x2="10" y1="14" y2="4"></line> </svg>
                                                </button>
