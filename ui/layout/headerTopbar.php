...
<div class="topbar">
    ...
    <div class="topbar-item">
        <a class="btn btn-icon btn-clean btn-lg mr-1" href="/en/admin/betacustomers">
...
<path d="M20,22 C21.6568542,22 23,20.6568542 23,19 C23,17.8954305 22,16.2287638 20,14 C18,16.2287638 17,17.8954305 17,19 C17,20.6568542 18.3431458,22 20,22 Z"
    ...
    <div class="dropdown">
        ...
        <!--end::Toggle-->
        <!--begin::Dropdown-->
        <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right d-none">
            <!--begin::Nav-->
