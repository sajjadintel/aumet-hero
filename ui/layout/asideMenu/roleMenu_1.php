<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        ...
        <ul class="menu-nav">
            ...
            <li class="menu-item" aria-haspopup="true">
                <a href="javascript:;" class="menu-link" onclick="WebApp.loadPage('inquiries')">
					<span class="svg-icon menu-icon">
						<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                    ...
                    <span class="menu-text font-size-h6">Inquiries</span>
                </a>
            </li>
            ...
            <li class="menu-item" aria-haspopup="true">
                <a href="javascript:;" class="menu-link" onclick="WebApp.loadPage('businessOppotunities')">
					<span class="svg-icon menu-icon">
						<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text font-size-h6">Business Opportunities</span>
                </a>
            </li>
