...
<head>
	...
	<link rel="canonical" href="https://aumet.com" />
	<!--begin::Fonts-->
	...
	<link href="/theme/assets/css/style.bundle<?php echo $cssDirection == "ltr" ? "" : ".rtl" ?>.css" rel="stylesheet" type="text/css" />
	<!--end::Global Theme Styles-->
	<!--begin::Layout Themes(used by all pages)-->
	<link href="/theme/assets/css/themes/layout/header/base/light<?php echo $cssDirection == "ltr" ? "" : ".rtl" ?>.min.css" rel="stylesheet" type="text/css" />
	<link href="/theme/assets/css/themes/layout/header/menu/light<?php echo $cssDirection == "ltr" ? "" : ".rtl" ?>.min.css" rel="stylesheet" type="text/css" />
	<link href="/theme/assets/css/themes/layout/brand/light<?php echo $cssDirection == "ltr" ? "" : ".rtl" ?>.min.css" rel="stylesheet" type="text/css" />
	<link href="/theme/assets/css/themes/layout/aside/light<?php echo $cssDirection == "ltr" ? "" : ".rtl" ?>.min.css" rel="stylesheet" type="text/css" />
	<!--end::Layout Themes-->
...
<body id="kt_body" class="header-fixed header-mobile-fixed <?php echo !$vIsPlatformLocked ? "aside-enabled aside-fixed aside-minimize-hoverable aside-minimize" : ""; ?>  page-loading">
	...
	<div class="d-flex flex-column flex-root" id="kt_root">
		...
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<!--end::Header-->
				<!--begin::Content-->
				<div class="content d-flex flex-column flex-column-fluid p-7" id="kt_content">
				</div>
				<!--end::Content-->
	...
	<script>
		var rootURL = "<?php echo $onexRootDomainUrl; ?>";
    ...
    <script type="text/javascript" src="/assets/js/jquery.typewatch.js"></script>
