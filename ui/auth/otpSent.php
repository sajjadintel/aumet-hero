<script>
    firebase.analytics().setCurrentScreen('otp_email');
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <h5 class="text-center font-size-h5 text-dark pl-10 pr-10 pb-10">
                                    We've sent a confirmation email to (<?php echo $_SESSION['otpUserEmail']; ?>). Please verify your email address by clicking on the link you will find there. If you don't see it don't forget to check the spam.
                                </h5>

                                <form method="post" action="/en/auth/resend/otp">
                                    <div class="form-group text-left pb-10">
                                        <label class="font-size-h6 font-weight-bolder text-dark"><?php echo $vLogin_email ?></label>
                                        <div class="input-group">
                                            <input class="form-control h-auto py-5 px-6 border-1 font-size-h6" type="text" name="email" value="<?php echo $_SESSION['otpUserEmail']; ?>"/>
                                            <div class="input-group-append">
                                                <button class="btn btn-primary px-3 font-size-h5" type="button">Resend Email</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>

                                <img src="/assets/img/mailSent.svg" class="max-h-300px" alt="" style=""/>
                            </div>
                        </div>
                    </div>
                </div>
