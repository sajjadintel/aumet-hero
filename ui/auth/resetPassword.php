        ...
        <div class="login-content flex-row-fluid d-flex flex-column p-10">
            ...
            <div class="d-flex flex-row-fluid flex-center">
                <div class="login-form">
                    <!--begin::Form-->
                    <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_login_forgot_form" method="post" action="/en/auth/reset" novalidate="novalidate">
                        <!--begin::Title-->
                        ...
                        <div class="form-group fv-plugins-icon-container">
                            ...
                            <input class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 mb-10" type="password" placeholder="New Password" name="password" autocomplete="off">
                            <input class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" type="password" placeholder="Confirm Password" name="confirmpassword" autocomplete="off">
                            <div class="fv-plugins-message-container"></div>
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="form-group d-flex flex-wrap">
                            <button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Recover my account</button>
