...
class AumetFileUploader
{
    ...
    public static function upload($distination, $arrFileParams, $saveFileName){
        ...
        if($fileName != "" && $fileName != null){
            ...
            if($distination == "files"){
                ...
                try {
                    ...
                    $objResult->fileLink = "https://d2qyez1diqag7p.cloudfront.net/uploads/$targetFileName";
